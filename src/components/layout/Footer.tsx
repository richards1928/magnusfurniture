...
export function Footer() {
  return (
    <footer style={{ background: 'var(--color-dark)', color: 'var(--color-gray-400)' }}>
      {/* Main Footer */}
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        <div className="container" style={{
          ...
          <div style={{ display: 'flex', gap: 'var(--space-4)' }}>
            <a href="https://wa.me/919090626209" target="_blank" rel="noopener noreferrer"
              style={{ color: 'var(--color-gray-500)', transition: 'color var(--duration-fast)' }}
              aria-label="WhatsApp"
            >
